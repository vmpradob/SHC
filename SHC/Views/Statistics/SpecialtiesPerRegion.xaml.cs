...
{
	/// <summary>
	/// Interaction logic for SpecialtiesPerRegion.xaml
	/// </summary>
	public partial class SpecialtiesPerRegion : Page, INotifyPropertyChanged
	{
		...
		private void UpdateGraph()
		{
			...
			var result = diagnostics.GroupBy(x => x.Doctor.Specialty.Name)
				.Select(group => new
				{
					Name = group.Key,
					Count = group.Count()
